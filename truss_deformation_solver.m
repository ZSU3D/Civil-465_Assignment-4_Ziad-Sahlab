...
%simply supported truss bridge. The 
%Author: Ziad Sahlab
%Acknolodgment: This code has been adapted and modified from the code used
%tosolve assignment 1 of the course Non-linear analysis of structures. The
